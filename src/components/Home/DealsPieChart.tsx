...
//             where("assignedTo", "==", loggedInUserId)
//           );
//           const snapshot = await getDocs(q);
//           console.log(`${category} count:`, snapshot.size); // Log the count for each category
//           statusCounts[category] = snapshot.size;
//         }
    
//         const chartData = collections.map((category) => ({
//           name: category,
//           value: statusCounts[category],
//           real: statusCounts[category],
//         }));
...
//     fetchDeals(); // Fetch the data on component mount
//   }, [loggedInUserId]); // Re-run when the logged-in user ID changes
...
//         <Spin tip="Loading chart..." />
//       ) : data.length === 0 ? (
//         <p>No tasks available for this user in any category.</p>
//       ) : (
//         <ResponsiveContainer width="100%" height={400}>
//           <PieChart>
//             <Pie
